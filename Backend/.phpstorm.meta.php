...
'filesystems.links./var/www/html/public/storage','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'sanctum.expiration','sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.verify_csrf_token',
...
'session.same_site','session.partitioned','view.paths','view.compiled','data.date_format',
...
'data.throw_when_max_transformation_depth_reached','data.commands.make.namespace','data.commands.make.suffix','data.livewire.enable_synths','flare.key',
